...
$attendance = mysqli_query($conn, "SELECT a.*, u.fullname, u.employee_id, u.department FROM attendance a JOIN users u ON a.user_id = u.id ORDER BY a.date DESC LIMIT 100");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="attendance.php" class="nav-item active"><i class="fas fa-calendar-check"></i><span>Attendance</span></a>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title"><h1>Attendance Records</h1><p>View all employee attendance</p></div>
        ...
        <div class="card">
            <div class="card-header"><h2><i class="fas fa-calendar-alt"></i> All Attendance Logs</h2></div>
            <table>
                <thead><tr><th>Date</th><th>Employee</th><th>ID</th><th>Department</th><th>Check In</th><th>Check Out</th><th>Hours</th><th>Status</th></tr></thead>
                <tbody>
